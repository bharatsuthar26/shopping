...
import { postRegis } from '../services/Myservice';
...
export default function Regis() {
  ...
  const handleSubmit = (event) => {
    ...
    const formData={ email: data.get('email'), password: data.get('password'),firstName: data.get('firstName'),lastName: data.get('lastName'),contactNumber: data.get('contactNumber')}
